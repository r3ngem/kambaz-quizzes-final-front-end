...
const updateModule = async (courseId, module)=>{
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("".concat(COURSES_API, "/").concat(courseId, "/modules/").concat(module._id), module);
    return data;
};
const deleteModule = async (courseId, moduleId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("".concat(COURSES_API, "/").concat(courseId, "/modules/").concat(moduleId));
...
function Modules() {
    ...
    const onUpdateModule = async (module)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$Kambaz$292f$Courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateModule"](cid, module);
    ...
    const onRemoveModule = async (moduleId)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$Kambaz$292f$Courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteModule"](cid, moduleId);
...
_s(Modules, "tquK7IC10ab2THqzSlEkhb1bdBU=", false, function() {
    return [
